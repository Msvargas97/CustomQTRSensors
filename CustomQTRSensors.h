...
#ifndef CustomQTRSensors_h
#define CustomQTRSensors_h
...
class QTRSensors
{
  public:
    ...
    int readLine(unsigned int *sensor_values, unsigned char readMode = QTR_EMITTERS_ON, unsigned char white_line = 0,int noise=50,int MAX = 1000);
  ...
  protected:
    ...
    int _lastValue;
	unsigned char readModeCalibrate;
